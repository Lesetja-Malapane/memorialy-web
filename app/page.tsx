    ...
    <div className="min-h-screen bg-[#050505] text-white selection:bg-indigo-500/30">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#050505]/80 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <Link
            href="https://apps.apple.com/us/app/memorialy-ai-journal/id6760933658"
            className="bg-white text-black px-6 py-2.5 rounded-full text-sm font-bold hover:bg-gray-200 transition-all"
          >
            Get the App!
          </Link>
        </div>
      ...
      <section className="relative pt-40 pb-20 px-6 overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
            Drop in your thoughts, photos, and daily moments. Memorialy&apos;s
            intelligent AI organizes, reflects, and helps you understand your
            mind.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
            <button className="w-full sm:w-auto bg-white text-black px-8 py-4 rounded-2xl font-bold text-lg hover:scale-105 transition-transform flex items-center justify-center">
              ...
              <Link href="https://apps.apple.com/us/app/memorialy-ai-journal/id6760933658">
                Available on iOS
              </Link>
            </button>
          </div>
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 space-y-6">
            ...
            <h2 className="text-4xl font-bold">
              Chats that actually explain your thoughts.
            </h2>
            <p className="text-gray-400 text-lg leading-relaxed">
              Don&apos;t just write into the void. Memorialy&apos;s AI Chat
              analyzes your recent entries to help you uncover patterns in your
              mood, habits, and daily life.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 space-y-6">
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              Powered by an offline-first Isar database, your journals load
              instantly whether you have a signal or not. Securely synced to the
              cloud only when you&apos;re ready.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                text: "The AI chat helped me realize patterns in my mood I never would have noticed on my own. It's like a therapist in my pocket.",
                author: "Sarah J.",
              },
              {
                text: "Finally, a journaling app that doesn't feel cluttered. The rich text editor is flawless, and the dark mode is gorgeous.",
                author: "Michael T.",
              },
              {
                text: "I travel a lot, so the offline-first sync is a lifesaver. I can journal on the plane and know it's safely backed up later.",
                author: "Elena R.",
              },
            ].map((review, i) => (
              <div
                key={i}
                className="bg-[#0A0A0A] p-8 rounded-3xl border border-white/5 flex flex-col justify-between"
              >
          ...
          {[
            {
              ...
              a: "Yes. Memorialy uses industry-standard Firebase encryption and stores data locally on your device using Isar until it is securely synced.",
            },
            {
              q: "Do I need internet to use it?",
              a: "No. Memorialy is built offline-first. You can write, edit, and organize your journals completely offline.",
            },
            {
              q: "What is Memorialy Pro?",
              a: "Memorialy Pro unlocks unlimited AI Chat sessions, advanced media uploads, and premium themes.",
            },
          ].map((faq, i) => (
            <details
              key={i}
      ...
      <section id="download" className="py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-br from-white/5 to-white/[0.01] border border-white/10 rounded-[3rem] p-12 sm:p-20 backdrop-blur-sm">
          ...
          <p className="text-gray-400 text-lg mb-10">
            Join the thousands organizing their minds with Memorialy.
          </p>
